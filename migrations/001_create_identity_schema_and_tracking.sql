-- =============================================================================
-- 001_create_identity_schema_and_tracking.sql
-- =============================================================================
...
-- table from the moment 001 is applied.
-- =============================================================================
...
COMMENT ON TABLE public.spark_match_migrations IS 'node-pg-migrate tracking table. Pre-created here so the table exists from the first 001 apply.';
